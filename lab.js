...
console.log('I love to code!')
  ...
  console.log('Coding has challendes')
}
...
if(amysBirthYear == brittanisBirthYear){
  console.log('Any and Brittney were born in the same year')
} else {
...
if (temperature >= 89 && rain == true){
  console.log('one should wear a t-shirt and take an umbrella')
    ...
    console.log('wear a jacket and carry an unbella')
  } else if (temperature >=60 && rain == false) {
    console.log('wear a t-shirt')
  } else if (temperature >= 61 && temperature <= 70 && rain == false){
